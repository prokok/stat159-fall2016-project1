...
http://kirkstrobeck.github.io/whatismarkdown.com/s
http://pandoc.org/
...
Explaining the relationship between Bash, Markdown, Pandoc, Git, Github and a text editor

-What were the challenging part,
Providing examples why reproducibility is important in data analysis process

 -What things stuck with
Using Git commands to link the local repository to my remote repository on Github

-What was the most consuming part
Writing down the notion and reason why we use those programs in my own words
